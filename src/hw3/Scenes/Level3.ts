...
export default class Level3 extends HW3Level {
    ...
    public constructor(viewport: Viewport, sceneManager: SceneManager, renderingManager: RenderingManager, options: Record<string, any>) {
        ...
        this.swingKey = Level3.SWING_KEY;
        this.playerDeathSoundKey = Level3.PLAYER_DEATH_KEY;
        this.playerHurtSoundKey = Level3.PLAYER_HURT_KEY;

        // Sprites
        this.HP_KEY = Level3.HP_KEY;
        this.BOSS_HP_KEY = Level3.BOSS_HP_KEY;
        ...
        this.POTION_KEY = Level3.POTION_KEY;
    ...
    public loadScene(): void {
        ...
        this.load.audio(this.swingKey, Level3.SWING_PATH);
        this.load.audio(this.playerHurtSoundKey, Level3.PLAYER_HURT_PATH);
        this.load.audio(this.playerDeathSoundKey, Level3.PLAYER_DEATH_PATH);
        // Game UI sprites
        this.load.image(this.HP_KEY, Level3.HP_PATH);
        this.load.image(this.BOSS_HP_KEY,Level3.BOSS_HP_PATH);
        ...
        this.load.image(this.POTION_KEY, Level3.POTION_PATH);
    ...
    protected initializeEnemies() {
        ...
        this.initializeEnemy(this.jellySpriteKey, new Vec2(2000, 1216), 10);
        this.initializeEnemy(this.jellySpriteKey, new Vec2(2100, 1216), 10);
    }
